<?php 
use Bang\Lib\Bundle;
$frontData2 = json_encode(Bang\Lib\ResponseBag::Get('frontData2'));
...
<div id="vue">
    <div class="bg">
        <div class="index_productdiv">
            <div class="index_product" v-for="(itme,index) in ReversedProInfo">
...
<script>
    let vue = new Vue({
        ...
        data : function(){
            return {
                product_inof: <?php print_r($frontData2);?>
            }
        },
        mounted: function() {
